    ...
    <div className="w-full h-screen text-center flex justify-center items-center" >
        <div className="group w-3/4 md:w-1/2 p-8 mx-auto my-auto  rounded-2xl border border-neutral-600 shadow-md bg-neutral-50/25 dark:bg-neutral-900/25 dark backdrop-blur-sm" >
            ...
            <div  className="flex w-3/4 md:w-1/2 justify-between items-center py-4 m-auto" >
                <div>
                    <FaLinkedinIn size={24} className="text-neutral-600 dark:text-neutral-200" />
                </div>
                <div>
                    <FaGithub size={24} className="text-neutral-600 dark:text-neutral-200" />
                </div>
                <div>
                    <Email size={24} className="text-neutral-600 dark:text-neutral-200" />
                </div>
                <div>
                    <FaDiscord size={24} className="text-neutral-600 dark:text-neutral-200" />
                </div>
            </div>
